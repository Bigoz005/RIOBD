--------------------------------------------------------
--  File created - czwartek-paŸdziernika-18-2018   
--------------------------------------------------------
-- Unable to render TABLE DDL for object HR.COUNTRIES with DBMS_METADATA attempting internal generator.
...
COMMENT ON COLUMN HR.COUNTRIES.REGION_ID IS 'Region ID for the country. Foreign key to region_id column in the departments table.';COMMENT ON TABLE HR.COUNTRIES IS 'country table. Contains 25 rows. References with locations table.'ALTER TABLE HR.COUNTRIES
ADD CONSTRAINT COUNTRY_ID_NN CHECK 
("COUNTRY_ID" IS NOT NULL)
ENABLEALTER TABLE HR.COUNTRIES
...
ENABLECREATE TABLE HR.COUNTRIES 
(
...
NOPARALLEL 
PCTTHRESHOLD 50
-- Unable to render TABLE DDL for object HR.DEPARTMENTS with DBMS_METADATA attempting internal generator.
...
COMMENT ON COLUMN HR.DEPARTMENTS.LOCATION_ID IS 'Location id where a department is located. Foreign key to location_id column of locations table.';COMMENT ON TABLE HR.DEPARTMENTS IS 'Departments table that shows details of departments where employees
work. Contains 27 rows; references with locations, employees, and job_history tables.'CREATE UNIQUE INDEX HR.DEPT_ID_PK ON HR.DEPARTMENTS (DEPARTMENT_ID ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
INITRANS 2 
...
NOPARALLELALTER TABLE HR.DEPARTMENTS
ADD CONSTRAINT DEPT_ID_PK PRIMARY KEY 
(
  DEPARTMENT_ID 
)
USING INDEX HR.DEPT_ID_PK
ENABLEALTER TABLE HR.DEPARTMENTS
...
ENABLECREATE TABLE HR.DEPARTMENTS 
(
...
NOCOMPRESS 
NOPARALLEL
-- Unable to render TABLE DDL for object HR.EMPLOYEES with DBMS_METADATA attempting internal generator.
...
ENABLECOMMENT ON COLUMN HR.EMPLOYEES.EMPLOYEE_ID IS 'Primary key of employees table.';
...
column of the departments table';COMMENT ON TABLE HR.EMPLOYEES IS 'employees table. Contains 107 rows. References with departments,
jobs, job_history tables. Contains a self reference.'CREATE INDEX HR.EMP_DEPARTMENT_IX ON HR.EMPLOYEES (DEPARTMENT_ID ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
INITRANS 2 
...
ENABLECREATE TABLE HR.EMPLOYEES 
(
...
NOCOMPRESS 
NOPARALLEL
-- Unable to render TABLE DDL for object HR.JOB_HISTORY with DBMS_METADATA attempting internal generator.
...
COMMENT ON COLUMN HR.JOB_HISTORY.DEPARTMENT_ID IS 'Department id in which the employee worked in the past; foreign key to deparment_id column in the departments table';COMMENT ON TABLE HR.JOB_HISTORY IS 'Table that stores job history of the employees. If an employee
changes departments within the job or changes jobs within the department,
new rows get inserted into this table with old job information of the
employee. Contains a complex primary key: employee_id+start_date.
Contains 25 rows. References with jobs, employees, and departments tables.'CREATE INDEX HR.JHIST_DEPARTMENT_IX ON HR.JOB_HISTORY (DEPARTMENT_ID ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
INITRANS 2 
...
NOPARALLELALTER TABLE HR.JOB_HISTORY
...
ENABLEALTER TABLE HR.JOB_HISTORY
...
ENABLECREATE TABLE HR.JOB_HISTORY 
(
  EMPLOYEE_ID NUMBER(6, 0) NOT NULL 
...
NOCOMPRESS 
NOPARALLEL
-- Unable to render TABLE DDL for object HR.JOBS with DBMS_METADATA attempting internal generator.
...
COMMENT ON COLUMN HR.JOBS.MAX_SALARY IS 'Maximum salary for a job title';COMMENT ON TABLE HR.JOBS IS 'jobs table with job titles and salary ranges. Contains 19 rows.
References with employees and job_history table.'CREATE UNIQUE INDEX HR.JOB_ID_PK ON HR.JOBS (JOB_ID ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
INITRANS 2 
...
NOCOMPRESS 
NOPARALLEL
-- Unable to render TABLE DDL for object HR.LOCATIONS with DBMS_METADATA attempting internal generator.
...
located. Foreign key to country_id column of the countries table.';COMMENT ON TABLE HR.LOCATIONS IS 'Locations table that contains specific address of a specific office,
warehouse, and/or production site of a company. Does not store addresses /
locations of customers. Contains 23 rows; references with the
departments and countries tables. 'CREATE INDEX HR.LOC_CITY_IX ON HR.LOCATIONS (CITY ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
INITRANS 2 
...
NOPARALLELALTER TABLE HR.LOCATIONS
ADD CONSTRAINT LOC_ID_PK PRIMARY KEY 
(
  LOCATION_ID 
)
USING INDEX HR.LOC_ID_PK
ENABLEALTER TABLE HR.LOCATIONS
...
ENABLECREATE TABLE HR.LOCATIONS 
(
...
NOCOMPRESS 
NOPARALLEL
-- Unable to render TABLE DDL for object HR.REGIONS with DBMS_METADATA attempting internal generator.
...
Insert into HR.EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID) values ('178','Kimberely','Grant','KGRANT','011.44.1644.429263',to_date('07/05/24','RR/MM/DD'),'SA_REP','7000','0,15','149','60');
...
Insert into HR.JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) values ('178',to_date('07/05/24','RR/MM/DD'),to_date('16/12/11','RR/MM/DD'),'SA_REP',null);
...
-- Unable to render INDEX DDL for object HR.DEPT_ID_PK with DBMS_METADATA attempting internal generator.
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.DEPT_LOCATION_IX with DBMS_METADATA attempting internal generator.
CREATE INDEX HR.DEPT_LOCATION_IX ON HR.DEPARTMENTS (LOCATION_ID ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.EMP_DEPARTMENT_IX with DBMS_METADATA attempting internal generator.
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.EMP_EMAIL_UK with DBMS_METADATA attempting internal generator.
CREATE UNIQUE INDEX HR.EMP_EMAIL_UK ON HR.EMPLOYEES (EMAIL ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.EMP_EMP_ID_PK with DBMS_METADATA attempting internal generator.
CREATE UNIQUE INDEX HR.EMP_EMP_ID_PK ON HR.EMPLOYEES (EMPLOYEE_ID ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.EMP_JOB_IX with DBMS_METADATA attempting internal generator.
CREATE INDEX HR.EMP_JOB_IX ON HR.EMPLOYEES (JOB_ID ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.EMP_MANAGER_IX with DBMS_METADATA attempting internal generator.
CREATE INDEX HR.EMP_MANAGER_IX ON HR.EMPLOYEES (MANAGER_ID ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.EMP_NAME_IX with DBMS_METADATA attempting internal generator.
CREATE INDEX HR.EMP_NAME_IX ON HR.EMPLOYEES (LAST_NAME ASC, FIRST_NAME ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.JHIST_DEPARTMENT_IX with DBMS_METADATA attempting internal generator.
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.JHIST_EMP_ID_ST_DATE_PK with DBMS_METADATA attempting internal generator.
CREATE UNIQUE INDEX HR.JHIST_EMP_ID_ST_DATE_PK ON HR.JOB_HISTORY (EMPLOYEE_ID ASC, START_DATE ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.JHIST_EMPLOYEE_IX with DBMS_METADATA attempting internal generator.
CREATE INDEX HR.JHIST_EMPLOYEE_IX ON HR.JOB_HISTORY (EMPLOYEE_ID ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.JHIST_JOB_IX with DBMS_METADATA attempting internal generator.
CREATE INDEX HR.JHIST_JOB_IX ON HR.JOB_HISTORY (JOB_ID ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.JOB_ID_PK with DBMS_METADATA attempting internal generator.
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.LOC_CITY_IX with DBMS_METADATA attempting internal generator.
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.LOC_COUNTRY_IX with DBMS_METADATA attempting internal generator.
CREATE INDEX HR.LOC_COUNTRY_IX ON HR.LOCATIONS (COUNTRY_ID ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.LOC_ID_PK with DBMS_METADATA attempting internal generator.
CREATE UNIQUE INDEX HR.LOC_ID_PK ON HR.LOCATIONS (LOCATION_ID ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.LOC_STATE_PROVINCE_IX with DBMS_METADATA attempting internal generator.
CREATE INDEX HR.LOC_STATE_PROVINCE_IX ON HR.LOCATIONS (STATE_PROVINCE ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
...
NOPARALLEL
-- Unable to render INDEX DDL for object HR.REG_ID_PK with DBMS_METADATA attempting internal generator.
CREATE UNIQUE INDEX HR.REG_ID_PK ON HR.REGIONS (REGION_ID ASC) 
NOLOGGING 
TABLESPACE EXAMPLE 
PCTFREE 10 
...
NOPARALLEL
-- Unable to render SYNONYM DDL for object HR.HR_EMP with DBMS_METADATA attempting internal generator.
CREATE SYNONYM HR.HR_EMP FOR HR.EMPLOYEES
